#ifndef UNBOUNDED_ORDERED_TREE_DFS_POSTORDER_ITERATOR_T_TPP
#define UNBOUNDED_ORDERED_TREE_DFS_POSTORDER_ITERATOR_T_TPP
...
namespace unbounded_ordered {
  ...
  class tree<T>::dfs_postorder_iterator_t
      : public tree<T>::template bidirectional_iterator_t<T_value> {
  protected:
    dfs_postorder_iterator_t(node<T>* root, node<T>* current,
    ...
    inline void next() {
      switch(this->_status) {
        ...
        case bidirectional_iterator_t<T_value>::BIDIRECTIONAL_ITERATOR_MIDDLE: {
          std::pair<node<T>*, typename node<T>::NodeLastMovement> next = this->_current->dfs_postorder_next();
    ...
    inline void previous() {
      switch(this->_status) {
        case bidirectional_iterator_t<T_value>::BIDIRECTIONAL_ITERATOR_BEGIN:
          ...
          break;
        case bidirectional_iterator_t<T_value>::BIDIRECTIONAL_ITERATOR_MIDDLE: {
          std::pair<node<T>*, typename node<T>::NodeLastMovement> previous = this->_current->dfs_postorder_previous();
  ...
  public:
    dfs_postorder_iterator_t() : bidirectional_iterator_t<T_value>() {}
  };
}

#endif // UNBOUNDED_ORDERED_TREE_DFS_POSTORDER_ITERATOR_T_TPP